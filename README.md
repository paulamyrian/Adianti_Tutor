# Adianti_Tutor
A aplicação tutor é um pequeno sistema construído com o Adianti Framework que pretende demonstrar algumas funcionalidades do Framework. O tutor não pretende ser uma aplicação para usuário final, mas apenas demonstrar as características do framework para desenvolvedores.

Criado por Pablo Dall'Oglio adianti@adianti.com.br Home-page: https://adiantiframework.com.br/tutor
